...
- (void)setMenuCellTitle:(NSString *)title
{
    ...
    else if ([title isEqualToString:@"Medium"])
    {
        ...
        // Set the scope
        int meduimQuestionsAnswered = (int)[userDefaults integerForKey:@"MediumQuestionsAnswered"];
        int meduimQuestionsCorrect = (int)[userDefaults integerForKey:@"MediumQuestionsAnsweredCorrectly"];
        self.scoreLabel.text = [NSString stringWithFormat:@"%i/%i", meduimQuestionsCorrect, meduimQuestionsAnswered];
